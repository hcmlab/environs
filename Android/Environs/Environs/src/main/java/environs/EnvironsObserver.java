package environs;
/**
 * EnvironsObserver - Each method of this class is called back
 * by Environs in order to deliver notifications, status, events,
 * etc.&nbsp; Derive from this class and implement the methods
...
/**
*	EnvironsObserver - Each method of this class is called back by Environs in order to deliver notifications, status, events, etc.&nbsp;
*	Derive from this class and implement the methods which you are interested in.
 *  Attachable to **Environs** objects in order to receive all notifications that the Environs instance processes or submits to the platform layer.
*	---------------------------------------------------------
*	Copyright (C) Chi-Tai Dang
*   All rights reserved.
*
...
* ****************************************************************************************
*/
public interface EnvironsObserver {
	/**
	 * OnStatus is called whenever the framework status changes.&nbsp;
	 *
	 * @param Environs_STATUS_      A status constant of type environs.Status
	 */
	void OnStatus ( @Status.Value int Environs_STATUS_ );
