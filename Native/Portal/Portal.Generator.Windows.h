...
*/
#pragma once
#ifndef INCLUDE_HCM_ENVIRONS_PORTALGENERATOR_WINDOWS_H
#define INCLUDE_HCM_ENVIRONS_PORTALGENERATOR_WINDOWS_H
...
namespace environs 
{
	...
	* ****************************************************************************************
	*/
	class PortalGeneratorWindows : public PortalGenerator
	{
	public:
		virtual ~PortalGeneratorWindows ();
...
#endif // INCLUDE_HCM_ENVIRONS_PORTALGENERATOR_WINDOWS_H
