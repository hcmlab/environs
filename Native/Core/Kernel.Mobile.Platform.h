 ...
 */
#pragma once
#ifndef INCLUDE_HCM_ENVIRONS_KERNEL_MOBILES_PLATFORM_H
#define INCLUDE_HCM_ENVIRONS_KERNEL_MOBILES_PLATFORM_H
...
#endif // INCLUDE_HCM_ENVIRONS_KERNEL_MOBILES_PLATFORM_H
