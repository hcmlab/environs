...
*/
#pragma once
#ifndef INCLUDE_HCM_ENVIRONS_PORTAL_BASE_NULL_H
#define INCLUDE_HCM_ENVIRONS_PORTAL_BASE_NULL_H
...
namespace environs 
{
	...
	* ****************************************************************************************
	*/
	class BaseNULL : implements IPortalRenderer
	{
	public:
		BaseNULL ( void );
		virtual ~BaseNULL ();
...
#endif // INCLUDE_HCM_ENVIRONS_PORTAL_BASE_NULL_H
