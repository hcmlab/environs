/**
 *	Portal Generator for Android devices
 * ------------------------------------------------------------------
 ...
 */
#pragma once
#ifndef INCLUDE_HCM_ENVIRONS_PORTALGENERATOR_ANDROID_H
#define INCLUDE_HCM_ENVIRONS_PORTALGENERATOR_ANDROID_H

#if !defined(DISPLAYDEVICE) && defined(ANDROID)
...
#endif // INCLUDE_HCM_ENVIRONS_PORTALGENERATOR_ANDROID_H
