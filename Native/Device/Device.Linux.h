/**
 * DeviceController for Linux platforms
 * ------------------------------------------------------------------
...
#ifndef INCLUDE_HCM_ENVIRONS_DEVICECONTROLLER_LINUX_H_
#define INCLUDE_HCM_ENVIRONS_DEVICECONTROLLER_LINUX_H_
...
{
    /**
     *	DeviceController for a LINUX platform
     *
...
#endif /* INCLUDE_HCM_ENVIRONS_DEVICECONTROLLER_LINUX_H_ */
