 ...
 */
#pragma once
#ifndef INCLUDE_HCM_ENVIRONS_BEZEL_TOUCH_GESTURES_RECOGNIZER_H
#define INCLUDE_HCM_ENVIRONS_BEZEL_TOUCH_GESTURES_RECOGNIZER_H
...
namespace environs 
{
	...
	* ****************************************************************************************
	*/
	class GestureBezelTouch : implements IInputRecognizer
	{
	public:
		GestureBezelTouch ( void );
		virtual ~GestureBezelTouch ( );
